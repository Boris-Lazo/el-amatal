...
const repositorioRestablecimientoClave = new RepositorioRestablecimientoClave(
  db
);
...
const servicioAlmacenamiento = new ServicioAlmacenamiento(
  configuracionApp.rutas
);
...
const servicioAlbum = new ServicioAlbum(
  repositorioAlbum,
