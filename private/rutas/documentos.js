...
router.get('/thumbnail/:nombreArchivo', (req, res, next) =>
  controladorDocumento.obtenerMiniatura(req, res, next)
);
...
router.get('/', (req, res, next) =>
  controladorDocumento.listarDocumentos(req, res, next)
);

router.delete('/:id', autenticacion, (req, res, next) =>
  controladorDocumento.eliminarDocumento(req, res, next)
);
